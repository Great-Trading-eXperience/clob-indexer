	...
	},
	{
		...
		inputs: [
			...
			{ name: "_quoteCurrency", type: "address", internalType: "Currency" },
			{
				...
				components: [
					{ name: "minTradeAmount", type: "uint128", internalType: "Quantity" },
					{
					...
					{ name: "minOrderSize", type: "uint128", internalType: "Quantity" },
					{ name: "slippageTreshold", type: "uint8", internalType: "uint8" },
				],
			},
		],
