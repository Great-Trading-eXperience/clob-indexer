export const PoolManagerABI: any[] = [
  ...
  },
  {
    ...
    name: 'createPool',
    inputs: [
      { name: '_baseCurrency', type: 'address', internalType: 'Currency' },
      { name: '_quoteCurrency', type: 'address', internalType: 'Currency' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'currency2', type: 'address', internalType: 'Currency' }
    ],
    outputs: [
      {
        name: '',
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'liquidityScore', type: 'uint256', internalType: 'uint256' }
    ],
    outputs: [],
    stateMutability: 'nonpayable'
  },
  {
    type: 'event',
    name: 'CurrencyAdded',
    inputs: [{ name: 'currency', type: 'address', indexed: false, internalType: 'Currency' }],
    anonymous: false
  },
  {
    type: 'event',
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'baseCurrency', type: 'address', indexed: false, internalType: 'Currency' },
      { name: 'quoteCurrency', type: 'address', indexed: false, internalType: 'Currency' },
      { name: 'lotSize', type: 'uint256', indexed: false, internalType: 'uint256' },
      { name: 'maxOrderAmount', type: 'uint256', indexed: false, internalType: 'uint256' }
    ],
    anonymous: false
  },
  {
    ...
    inputs: [
      ...
      { name: 'newLiquidity', type: 'uint256', indexed: false, internalType: 'uint256' }
    ],
    anonymous: false
  },
