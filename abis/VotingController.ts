export const VotingControllerABI: any[] = [
	{
		type: "constructor",
		inputs: [
			{ name: "_veToken", type: "address", internalType: "address" },
			{
				name: "_tokenMsgSendEndpoint",
				type: "address",
	...
	},
	{
		...
		name: "addMultiPools",
		inputs: [
			{ name: "chainIds", type: "uint64[]", internalType: "uint64[]" },
	...
	},
	{
		...
		inputs: [{ name: "chainId", type: "uint64", internalType: "uint64" }],
		outputs: [],
		stateMutability: "payable",
	},
	{
	...
	},
	{
		...
		inputs: [
			{ name: "chainId", type: "uint64", internalType: "uint64" },
			{ name: "wTime", type: "uint128", internalType: "uint128" },
			{ name: "forcedTokenPerSec", type: "uint128", internalType: "uint128" },
		],
		outputs: [],
		stateMutability: "payable",
	},
	...
	},
	{
		...
		inputs: [
			{ name: "pool", type: "address", internalType: "address" },
			{ name: "wTimes", type: "uint128[]", internalType: "uint128[]" },
		],
		outputs: [
			{ name: "chainId", type: "uint64", internalType: "uint64" },
			{
			...
			{ name: "slopeChanges", type: "uint128[]", internalType: "uint128[]" },
		],
		stateMutability: "view",
	},
	{
	...
	},
	{
		...
		outputs: [
			{ name: "totalVotedWeight", type: "uint64", internalType: "uint64" },
			{
				name: "voteForPools",
				type: "tuple[]",
	...
	},
	{
		...
		outputs: [
			{ name: "isEpochFinalized", type: "bool", internalType: "bool" },
			{ name: "totalVotes", type: "uint128", internalType: "uint128" },
			{ name: "poolVotes", type: "uint128[]", internalType: "uint128[]" },
		],
		stateMutability: "view",
	},
	{
		...
		inputs: [
			{
				name: "_initialApproxDestinationGas",
				type: "uint256",
				internalType: "uint256",
			},
		],
	...
	{
		type: "function",
		name: "msgSendEndpoint",
		inputs: [],
		outputs: [
			{ name: "", type: "address", internalType: "contract IMsgSendEndpoint" },
		],
		stateMutability: "view",
	},
	{
	...
	},
	{
		...
		inputs: [{ name: "_helper", type: "address", internalType: "address" }],
		outputs: [],
		stateMutability: "nonpayable",
	},
	{
		...
		inputs: [{ name: "gas", type: "uint256", internalType: "uint256" }],
		outputs: [],
		stateMutability: "nonpayable",
	},
	{
	...
	},
	{
		...
		name: "setTokenPerSec",
		inputs: [
			{ name: "newTokenPerSec", type: "uint128", internalType: "uint128" },
		],
		outputs: [],
		stateMutability: "nonpayable",
	},
	...
	},
	{
		...
		name: "veToken",
		inputs: [],
		outputs: [{ name: "", type: "address", internalType: "contract IVeToken" }],
		stateMutability: "view",
	},
	{
		type: "function",
		...
		inputs: [
			{ name: "pools", type: "address[]", internalType: "address[]" },
			{ name: "weights", type: "uint64[]", internalType: "uint64[]" },
		],
		outputs: [],
		stateMutability: "nonpayable",
	},
	...
	{ type: "error", name: "ArrayOutOfBounds", inputs: [] },
	{
		type: "error",
	...
	{ type: "error", name: "InvalidInitialization", inputs: [] },
	{
		type: "error",
		name: "InvalidWTime",
		inputs: [{ name: "wTime", type: "uint128", internalType: "uint128" }],
	},
	...
	},
	{
		...
		inputs: [
			{ name: "totalVotedWeight", type: "uint256", internalType: "uint256" },
			{ name: "maxWeight", type: "uint256", internalType: "uint256" },
		],
	},
	{
		type: "error",
